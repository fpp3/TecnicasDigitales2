...
\lstinputlisting[language={[x86masm]Assembler}, caption={Archivo de inicialización y tabla de vectores (\texttt{crt.s}).}, label={list.ej1:crt}]{sources/src/crt.s}
...
\lstinputlisting[caption={Script de enlazado de memoria (\texttt{linker.ld}).}, label={list.ej1:linker}]{sources/src/linker.ld}
